...
export default function ProfilePage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-4xl font-bold text-[#2c2c2c]">Profile</h1>
      ...
      <div className="rounded-2xl bg-white p-8 shadow-sm">
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-6 border-b border-gray-200 pb-8">
            <div className="flex size-24 items-center justify-center rounded-full bg-[linear-gradient(135deg,#ffd4c4_0%,#f28b6c_44%,#1f2933_45%,#111827_100%)] text-2xl font-bold text-white">
              JD
            </div>
            <div>
              <h2 className="text-2xl font-bold text-[#2c2c2c]">John Doe</h2>
